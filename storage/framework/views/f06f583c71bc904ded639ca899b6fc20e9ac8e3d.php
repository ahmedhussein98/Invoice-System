        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form class="row" method="POST" action="<?php echo e(route('supplier.update', $supplier->id)); ?>">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <div class="form-group col-md-12">
                                <label class="control-label">Supplier Name</label>
                                <input value="<?php echo e($supplier->name); ?>" name="name" class="form-control <?php if ($errors->has('name')) :
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input value="<?php echo e($supplier->mobile); ?>" name="mobile" class="form-control <?php if ($errors->has('mobile')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>"><?php echo e($supplier->address); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>"><?php echo e($supplier->details); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input value="<?php echo e($supplier->previous_balance); ?>" name="previous_balance" class="form-control <?php if ($errors->has('previous_balance')) :
if (isset($message)) { $messageCache = $message; }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\codeastro\Laravel\SalesERP-Laravel\resources\views/supplier/edit.blade.php ENDPATH**/ ?>